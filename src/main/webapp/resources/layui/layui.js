...
!function(e) {
	...
	o.modules = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function(
		...
		return i && (t = e, e = []), layui["layui.all"] ? r.call(n) : (n.use(e,
				r), n)
		...
		function s(e, t) {
			...
			("load" === e.type || n
					...
					&& (o.modules[m] = t, y.removeChild(v), function i() {
						return ++p > 1e3 * o.timeout / 4 ? r(m
		...
		var m = e[0], p = 0;
		if (a = a || [], o.host = o.host
				|| (d.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length
				|| layui["layui.all"] && l[m])
			return "function" == typeof t && t.apply(layui, a), f;
		var v = n.createElement("script"), h = (l[m] ? d + "lay/" : o.base
				|| "")
				+ (f.modules[m] || m) + ".js";
		return v.async = !0, v.charset = "utf-8", v.src = h + function() {
			...
			return ++p > 1e3 * o.timeout / 4
					...
					: void("string" == typeof o.modules[m] && o.status[m]
							? c()
							: setTimeout(g, 4))
		}() : (y.appendChild(v), !v.attachEvent || v.attachEvent.toString
				&& v.attachEvent.toString().indexOf("[native code") < 0 || u
		...
		var u = this, l = n.createElement("link"), a = n
				.getElementsByTagName("head")[0];
		"string" == typeof t && (i = t);
		var s = (i || e).replace(/\.|\//g, ""), c = l.id = "layuicss-" + s, f = 0;
		l.rel = "stylesheet", l.href = e
				+ (o.debug ? "?v=" + (new Date).getTime() : ""), l.media = "all", n
				.getElementById(c)
				|| a.appendChild(l), "function" == typeof t && !function d() {
			return ++f > 1e3 * o.timeout / 100
					? r(e + " timeout")
					: void(1989 === parseInt(u.getStyle(n.getElementById(c),
							"width")) ? function() {
						t()
					}() : setTimeout(d, 100))
		}()
		...
		var i = this, r = null, u = t.match(/\(.*\)$/) || [], l = (t = e + "."
				+ t).replace(u, ""), a = function(e, t) {
			var o = t && t.call(i, n);
			o === !1 && null === r && (r = !1)
		};
